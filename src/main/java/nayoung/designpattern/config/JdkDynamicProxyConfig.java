...
public class JdkDynamicProxyConfig {
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace) {
        ...
        OrderControllerV1 proxy = (OrderControllerV1) Proxy.newProxyInstance(OrderControllerV1.class.getClassLoader(),
                new Class[]{OrderControllerV1.class}, new LogTraceHandler(orderController, logTrace, PATTERNS));
        return proxy;
    }
    ...
    public OrderServiceV1 orderServiceV1(LogTrace logTrace) {
        ...
        OrderServiceV1 proxy = (OrderServiceV1) Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(),
                new Class[]{OrderServiceV1.class}, new LogTraceHandler(orderService, logTrace, PATTERNS));
        return proxy;
    }
    ...
    public ItemRepositoryV1 itemRepositoryV1(LogTrace logTrace) {
        ...
        ItemRepositoryV1 proxy = (ItemRepositoryV1) Proxy.newProxyInstance(ItemRepositoryV1.class.getClassLoader(),
                new Class[]{ItemRepositoryV1.class}, new LogTraceHandler(itemRepository, logTrace, PATTERNS));
        return proxy;
    }
}
